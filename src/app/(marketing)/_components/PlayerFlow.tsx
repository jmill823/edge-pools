      ...
      <div className="mx-auto max-w-content px-4">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="font-body text-[11px] text-[#2D5F3B] hover:opacity-80 transition-opacity duration-200 cursor-pointer"
          >
            &larr; Back
          </button>
        </div>
        ...
        <p className="mt-2 font-body text-[11px] font-normal text-text-secondary leading-[1.5]">
        ...
        <Link
          href="/join"
          className="mt-8 flex items-center justify-center w-full rounded-[4px] bg-text-primary py-3.5 font-body text-[13px] font-semibold tracking-[0.5px] uppercase text-white hover:opacity-90 transition-opacity duration-200 active:scale-[0.98] min-h-[44px] cursor-pointer"
        >
          Join a Pool
        </Link>
        ...
        <button
          ...
          className="mt-4 w-full text-center font-body text-[10px] text-[#2D5F3B] hover:opacity-80 transition-opacity duration-200 cursor-pointer"
        >
