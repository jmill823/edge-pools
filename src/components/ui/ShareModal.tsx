      ...
      <div className="relative w-full max-w-md bg-surface rounded-t-card sm:rounded-card border border-border shadow-[0_4px_12px_rgba(0,0,0,0.08)] p-5 mx-4 mb-0 sm:mb-0">
        ...
        <div className="grid grid-cols-3 gap-3">
          <a
            ...
            className="rounded-[6px] border border-border bg-surface py-2.5 text-center font-body text-xs font-medium text-text-primary hover:bg-surface-alt transition-colors duration-200 min-h-[44px] flex flex-col items-center justify-center gap-1 cursor-pointer"
          >
